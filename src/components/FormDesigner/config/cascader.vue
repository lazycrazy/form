  ...
  <div>
    ...
    <el-form-item label="字典配置"
      ...
      <el-tabs v-model="dicOption" stretch @tab-click="handleTabClick">
        <el-tab-pane label="静态数据" name="1">
          <el-tree ref="tree" :data="data.options" default-expand-all draggable node-key="value" :expand-on-click-node="false">
            <span slot-scope="{ node, data }" class="custom-tree-node">
              ...
              <span>
                ...
                <el-button class="danger" type="text" size="mini" icon="el-icon-delete" @click="handleNodeRemove(node, data)"></el-button>
              </span>
            </span>
          </el-tree>
    ...
    <el-dialog :visible.sync="dialogVisible" :rules="dialogRules" :before-close="beforeClose">
      <el-form ref="dialogForm" :model="dialogForm" label-width="80px">
        ...
        <el-form-item label="value">
          <el-input v-model="dialogForm.value" placeholder="value" :type="this.dialogInputType">
            <el-select slot="append" v-model="dialogInputType" placeholder="数据类型" style="width: 100px">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus == 'add'" type="primary" @click="handleDialogAdd">确 定</el-button>
